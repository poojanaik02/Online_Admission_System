      ...
      {  
         ...
         try {
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/registration?useSSL=false", "root","root");
              ...
              PreparedStatement ps = con.prepareStatement("select education_detail.user,education_detail.cetmarks,education_detail.branch from education_detail where education_detail.cetmarks>=70 AND education_detail.cetmarks<85  order by education_detail.cetmarks DESC;");
